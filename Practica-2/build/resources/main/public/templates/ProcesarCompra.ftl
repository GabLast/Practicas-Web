            ...
            <div class="shadow p-4 rounded bg-black js-active card border border-3" data-animation="scaleIn">
                ...
                <div>
                    <div class="form-row mt-4">
                        ...
                        <#if logged == true>
                            <div class="col-12 col-sm-6"><input class="form-control" type="text" name="nombre" placeholder="${nombre}" required/></div>
                        <#else>
    ...
    <div class="col" >
      <div class="table-responsive" style="height: 300px">
        ...
        <div class="button-row d-flex">
            ...
            <div></div>
            <button class="btn btn btn-primary ml-auto" form="datos-cliente" type="submit">Procesar Compra</button>
        </div>
    </div>
  </div>
